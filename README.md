...
- [JNIDirect](https://github.com/Y-Sulphuris/JNIDirect) - Powerful library for creating platform-specific intrinsics using native methods and runtime machine code generation through C. Unfinished because I don't have a proper hardware to support ARM-based CPUs.
- [MemApi3](https://github.com/Y-Sulphuris/MemApi3) - Direct memory API, a complete analogue of the memory operations from sun.misc.Unsafe. Unfinished due to its dependence on JNIDirect.
- [JavaMemoryHandles](https://github.com/Y-Sulphuris/JavaMemoryHandles) - Analogue of Memory API from Java 22, but this one is for Java 8. Unfinished due to its dependence on MemApi3, which is unfinished due to its dependence on JNIDirect.
- [OpenArrays](https://github.com/Ydo4ki-Archive/OpenArrays) - Weird API for creation of static arrays within classes and access class fields via indexes with the same performance as direct access.
